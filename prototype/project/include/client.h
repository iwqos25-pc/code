...
namespace ECProject
{
  ...
  public:
    ...
    int node_repair(std::vector<int> &failed_node_list, double &cost, double &de_time, int &cross_rack_num, double &meta_time, double &cross_rt, double &inner_rt);
    int block_repair(std::vector<int> &failed_block_list, int stripe_id, double &cost, double &de_time, int &cross_rack_num, double &meta_time, double &cross_rt, double &inner_rt);
